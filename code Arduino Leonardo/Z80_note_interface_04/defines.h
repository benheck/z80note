...
const uint8_t slotFilename[] PROGMEM = {'S','L','O','T',49,'.','B','I','N', 0};			//For creating RAM dump filenames

const uint8_t OLEDboot[] PROGMEM = {    //Stream of commands to set up the OLED

SSD1306_DISPLAYOFF, SSD1306_SETDISPLAYCLOCKDIV, 0x80, SSD1306_SETMULTIPLEX, 63, SSD1306_SETDISPLAYOFFSET, 0x00,  SSD1306_SETSTARTLINE, SSD1306_CHARGEPUMP, 0x14,
SSD1306_MEMORYMODE, 0x00, 0xA1, SSD1306_COMSCANDEC, SSD1306_SETCOMPINS, 0x12, SSD1306_SETCONTRAST, 0xCF, SSD1306_SETPRECHARGE, 0xF1, SSD1306_SETVCOMDETECT, 0x40,
SSD1306_DISPLAYALLON_RESUME, SSD1306_NORMALDISPLAY, SSD1306_DEACTIVATE_SCROLL, SSD1306_DISPLAYON, SSD1306_COLUMNADDR, 0x00, 127, SSD1306_PAGEADDR, 0x00, 0x07
